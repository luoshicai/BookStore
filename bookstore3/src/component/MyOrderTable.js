...
import {Button, Input, message, Popconfirm, Space, Table, Modal, Form, Image, DatePicker} from 'antd';
import Highlighter from 'react-highlight-words';
import { SearchOutlined } from '@ant-design/icons';
import {FilterAllOrderByTime, FilterUserOrderByTime, GetOrderDetails} from "../service/orderService";
...
const OrderTable = (props) => {
    ...
    const handleDate = (date,dateString)=>{
        ...
        if (date1!==""){
            ...
            FilterUserOrderByTime(data,DateCallback);
        }
        else{
